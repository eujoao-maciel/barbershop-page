                    ...
                    <div className="flex w-full items-center justify-between py-5">
                        ...
                        <div className="flex flex-shrink-0 items-center justify-end lg:hidden">
                            <button
                                ...
                                className="flex h-11 w-11 items-center justify-center border border-gold-primary text-gold-primary transition-colors duration-200 hover:bg-gold-primary hover:text-black-primary"
