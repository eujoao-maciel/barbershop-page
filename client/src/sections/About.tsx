        ...
        >
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-14">
                ...
                <div className="grid items-stretch gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-10">
                    <div className="min-h-[22rem] rounded-sm border border-gold-primary/70 bg-surface-dark sm:min-h-[28rem]">
                        <img
                    ...
                    <div className="flex flex-col justify-between gap-8">
                        <div className="bg-surface-dark p-4 space-y-5 text-left">
                            <p className="text-sm leading-7 text-white-primary/65 sm:text-base">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            {highlights.map(({ label, value }) => (
                                <div
                                    key={label}
                                    className="rounded-sm border border-gold-primary/20 bg-black-primary px-5 py-6 text-center"
                                >
